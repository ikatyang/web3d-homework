...
export default {
  bedRoomWest: {
    ...
    nextTo: [null, null],
    walls: [
      [new Wall(balconyWest.width, roomHeight, 'north', { all: 'fb', right: 'r' }, 0, 2, -1, balconyWest.door, balconyWest.door.width / 2, 0, false), balconyWest.width / 2],
      ...
      [new Wall(bedRoomWest.depth, roomHeight, 'east', { all: 'fb', right: 'r' }, 0, 1, -3, bedRoomWest.door, bedRoomWest.door.width / 2, -0.5, true), bedRoomWest.depth / 2],
    ],
  },
  balconyWest: {
    ...
    walls: [
      ...
      [new Wall(balconyWest.width, 0, 'south', 'fb', 0, 1, -1, balconyWest.door, balconyWest.door.width / -2, -1.5, true), -balconyWest.width / 2],
    ],
  },
  drawingRoom: {
    height: roomHeight,
    ...
    walls: [
      [new Wall(drawingRoom.depth, roomHeight, 'west', { all: 'fb', left: 'l' }, 0, 1, 1, bedRoomWest.door, bedRoomWest.door.width / -2, 0, false), drawingRoom.depth / 2],
      [new Wall(drawingRoom.width, roomHeight, 'south', { all: 'fb', left: 'l', right: 'r' }, 0, 2, -1, drawingRoom.door, drawingRoom.door.width / 2, 0, true), drawingRoom.width / 2],
  ...
  balconyNorthWest: {
    ...
    walls: [
      ...
      [new Wall(balconyNorthWest.width, 0, 'south', 'fb', 0, 1, -1, balconyNorthWest.door, balconyNorthWest.door.width / 2, -1.5, true), balconyNorthWest.width / 2],
    ],
  },
  diningRoom: {
    height: roomHeight,
    ...
    walls: [
      [new Wall(diningRoom.width, roomHeight, 'north', { all: 'fb', left: 'l', right: 'r' }, 0, 2, -1, balconyNorthWest.door, balconyNorthWest.door.width / -2, 0, false), diningRoom.width / 2],
  ...
  toiletSouthEast: {
    ...
    nextTo: ['shaft', null],
    walls: [
      [new Wall(toiletSouthEast.width, roomHeight, 'north', { all: 'fb', left: 'l' }, 0, 1, -1, toiletSouthEast.door, toiletSouthEast.door.width / -2, -0.5, true), toiletSouthEast.width / 2],
  ...
  toiletSouth: {
    ...
    walls: [
      [new Wall(toiletSouth.width, roomHeight, 'north', { all: 'fb', right: 'r' }, 0, 2, -1, toiletSouth.door, toiletSouth.door.width / 2, 0, true), toiletSouth.width / 2],
  ...
  bedRoomEast: {
    ...
    walls: [
      ...
      [new Wall(balconyEast.width, roomHeight, 'north', { all: 'fb', left: 'l', right: 'r' }, 0, 2, 1, balconyEast.door, balconyEast.door.width / 2, 0, false), balconyEast.width / -2],
      [new Wall(aisle.depth, roomHeight, 'west', { all: 'fb', right: 'r' }, 0, 2, 0, bedRoomEast.door, bedRoomEast.door.width / -2, 0, true), aisle.depth / -2],
      [new Wall(bedRoomEast.depth - aisle.depth, roomHeight, 'west', 'fbl', 0, 1, -1), (bedRoomEast.depth - aisle.depth) / 2],
      [new Wall(bedRoomEast.width, roomHeight, 'south', { all: 'fb', right: 'r' }, 0, 1, -1, toiletSouthEast.door, toiletSouthEast.door.width / 2, 0, false), bedRoomEast.width / 2],
  ...
  aisle: {
    ...
    walls: [
      [new Wall(aisle.width, roomHeight, 'north', { all: 'fb', right: 'r' }, 0, 1, 1, bedRoomNorth.door, bedRoomNorth.door.width / 2, 0, false), aisle.width / 2],
    ],
  },
  bedRoomNorth: {
    height: roomHeight,
    ...
    walls: [
      [new Wall(bedRoomNorth.width, roomHeight, 'north', { all: 'fb', left: 'l' }, 0, 2, -1, balconyNorthEast.door, balconyNorthEast.door.width / -2, 0, false), bedRoomNorth.width / 2],
      ...
      [new Wall(bedRoomNorth.width, roomHeight, 'south', { all: 'fb', left: 'l' }, 0, 1, -3, bedRoomNorth.door, bedRoomNorth.door.width / -2, -0.5, true), bedRoomNorth.width / 2],
  ...
  balconyEast: {
    ...
    walls: [
      ...
      [new Wall(balconyEast.width, 0, 'south', 'fb', 0, 1, -1, balconyEast.door, balconyEast.door.width / -2, 0.5, true), balconyEast.width / 2],
    ],
  },
  balconyNorthEast: {
    height: balconyHeight,
    ...
    walls: [
      ...
      [new Wall(balconyNorthEast.width, 0, 'south', 'fb', 0, 1, -1, balconyNorthEast.door, balconyNorthEast.door.width / 2, -1.5, true), balconyNorthEast.width / 2],
